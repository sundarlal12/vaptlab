    ...
    <section id="approach" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          {/* Badge */}
          <div
            className="inline-block px-3 py-1 rounded-full font-medium tracking-widest text-sm mb-4 text-transparent bg-clip-text"
            style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {cards.map((c, idx) => (
            <article
              key={idx}
              className="relative rounded-xl bg-pink-50/60 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200"
            >
              {/* accent bottom bar */}
              <div
