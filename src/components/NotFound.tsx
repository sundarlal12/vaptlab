    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 flex items-center justify-center px-4 relative">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="relative mb-8">
          <div className="text-9xl font-bold text-gray-200 select-none">404</div>
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-32 h-32 rounded-full flex items-center justify-center animate-pulse bg-gradient-to-r from-pink-600 to-red-700">
              <AlertTriangle className="w-16 h-16 text-white" />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="inline-flex items-center justify-center px-8 py-3 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl text-white bg-gradient-to-r from-pink-600 to-red-700 hover:opacity-90"
          >
            <Home className="w-5 h-5 mr-2" />
            Back to Home
          </Link>
          ...
          <button
            onClick={() => window.history.back()}
            className="inline-flex items-center justify-center px-8 py-3 rounded-lg font-semibold transition-all duration-300 border-2 border-transparent text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-red-700 hover:bg-pink-50"
            style={{
        ...
        <div className="mt-12 p-6 bg-white/60 backdrop-blur-sm rounded-xl border border-white/20">
          ...
          <a
            href="mailto:contact@vaptlabs.com"
            className="font-medium transition-colors bg-gradient-to-r from-pink-600 to-red-700 bg-clip-text text-transparent"
          >
            contact@vaptlabs.com
          </a>
        </div>
        ...
        {/* Decorative Elements */}
        <div className="absolute top-20 left-20 w-20 h-20 bg-pink-200 rounded-full opacity-20 animate-bounce"></div>
        <div className="absolute bottom-20 right-20 w-16 h-16 bg-red-200 rounded-full opacity-20 animate-bounce" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-10 w-12 h-12 bg-rose-200 rounded-full opacity-20 animate-bounce" style={{ animationDelay: '2s' }}></div>
      </div>
    </div>
  );
};
