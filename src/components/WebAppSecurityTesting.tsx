...
// src/pages/WebAppSecurityTesting.tsx
import React, { useState } from 'react';
import {
  Monitor, Shield, FileText, Award, DollarSign,
...
/**
 * NOTE: This file was updated to use the red gradient theme:
 * const RED_GRAD = "linear-gradient(to right, rgb(217, 47, 97), rgb(143, 15, 56))";
 *
 * Changes are annotated inline with `// CHANGED: ...` comments so you can re-use them.
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mb-8 flex gap-4 justify-center md:justify-start">
                <button
                  className={`px-6 py-2 rounded-t-lg font-semibold ${activeTab === 'black' ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'}`}
                  onClick={() => setActiveTab('black')}
                >
                  Black Box
                </button>
                ...
                <button
                  className={`px-6 py-2 rounded-t-lg font-semibold ${activeTab === 'gray' ? 'bg-gray-400 text-white' : 'bg-gray-200 text-gray-600 hover:bg-gray-300'}`}
                  onClick={() => setActiveTab('gray')}
                >
                  Gray Box
                </button>

                {/* CHANGED: "White Box" tab button — used red gradient background instead of emerald */}
                <button
              ...
              <div className="text-center mt-8">
                {/* CHANGED: "Get Free Consultation" button uses red gradient */}
                <button
            ...
            <div className="relative">
              <div className="rounded-lg p-8" style={{ background: 'linear-gradient(180deg, rgba(217,47,97,0.06), rgba(143,15,56,0.04))' }}>
                {/* CHANGED: subtle red-tinted card background instead of emerald */}
                <img
      ...
      <div className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="relative w-32 h-32 mx-auto mb-6">
                {/* CHANGED: dashed border color to red-tint */}
                <div className="absolute inset-0 rounded-full" style={{ border: '4px dashed rgba(217,47,97,0.25)' }} />
                <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                  <DollarSign className="w-12 h-12 text-gray-800" />
                </div>
                <div className="absolute -top-2 -right-2">
                  <div className="w-8 h-8" style={{ background: RED_GRAD, borderRadius: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <ChevronRight className="w-4 h-4 text-white" />
                  </div>
                </div>
              </div>
