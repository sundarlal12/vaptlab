...
//           <p className="text-emerald-400 font-semibold mb-4 tracking-wider uppercase" style={{ background: "linear-gradient(to right, rgb(234, 0,1), rgb(234, 0, 1))",WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", }}>
//             CHOOSE WISELY
//           </p>
  ...
  return (
    <section className="py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p
            className="font-semibold mb-4 tracking-wider uppercase"
            style={{
